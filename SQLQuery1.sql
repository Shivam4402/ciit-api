...
Scaffold-DbContext "Server=115.124.106.98;Database=ciitstud_;User Id=ciituser;Password=CIIT#0908;TrustServerCertificate=True" Microsoft.EntityFrameworkCore.SqlServer -OutputDir TempModels -Table tbllead_sources_map, tblenquiry_for_map, tbl_enquiry_topic_map
